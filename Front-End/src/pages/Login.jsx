            ...
            <div className={`relative z-10 w-full max-w-md rounded-lg p-6 sm:p-8 md:p-10 ${theme === 'dark' ? 'bg-gray-900' : 'bg-white'} shadow-2xl`}>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button 
                        type="submit" 
                        disabled={loading}
                        className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:from-gray-600 disabled:to-gray-700 text-white py-2.5 rounded-lg font-bold transition-all duration-300 text-sm sm:text-base"
                    >
